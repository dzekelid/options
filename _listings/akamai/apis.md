...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/options/master/_listings/akamai/papi-v0-edgehostnames-edgehostnameid-contractid,groupid,options-get.md
x-common:
- type: x-base
